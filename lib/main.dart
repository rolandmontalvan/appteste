                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              '${_todos.where((todo) => todo.parent == '3').length} Alunos cadastrados',
                        ...
                        child: NotificationListener<ScrollNotification>(
                          onNotification: (notification) {
                            if (notification is ScrollEndNotification) {
                              print("Notificações = ${_pageController.page}");
                              var currentPage =
            ...
            children: [
              ...
              Container(
                ...
                child: Hero(
                  ...
                  child: Text(
                    "${getTotalTodos(task)} Cadastros de",
                    style: Theme.of(context)
                        .textTheme
                        .body1
