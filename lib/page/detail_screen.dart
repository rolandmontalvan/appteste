...
import 'package:todo/page/add_agente_de_campo_screen.dart';
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Hero(
                          ...
                          child: Text(
                            "${model.getTotalTodosFrom(_task)} Cadastros de",
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Deletar este cadastro?'),
              content: SingleChildScrollView(
                child: ListBody(
                  children: <Widget>[
                    Text(
                        'Este é um caminho sem volta! A exclusão os dados será irreversível.'),
                  ],
                ),
              ),
              actions: <Widget>[
